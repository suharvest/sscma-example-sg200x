...
run_sudo 'killall -q detection-blur face-analysis retail-vision ppocr-reader yolo8-detector yolo11-detector yolo26-detector yolo11s-detector sscma-node 2>/dev/null || true'
sleep 2
ok "Services stopped"
