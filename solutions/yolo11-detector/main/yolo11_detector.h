#ifndef _YOLO11_DETECTOR_H_
#define _YOLO11_DETECTOR_H_
...
/**
 * YOLO11 Detector with DFL (Distribution Focal Loss) post-processing
 *
 * YOLO11 output format:
 *   - bbox tensors: 1×64×H×W (4 coords × 16 DFL bins)
 *   - class tensors: 1×80×H×W (80-class scores)
 *   - 3 scales: 80×80 (stride 8), 40×40 (stride 16), 20×20 (stride 32)
 *
 * DFL decoding:
...
private:
    ...
    // Custom post-processing for YOLO11 with DFL
...
private:
    ...
    static constexpr int BBOX_CHANNELS = 64;  // 4 coords × 16 bins
