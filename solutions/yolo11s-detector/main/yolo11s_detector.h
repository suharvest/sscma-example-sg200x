#ifndef _YOLO11S_DETECTOR_H_
#define _YOLO11S_DETECTOR_H_
...
/**
 * YOLO11s Detector with DFL (Distribution Focal Loss) post-processing
 *
 * YOLO11s output format:
...
private:
    ...
    // Custom post-processing for YOLO11s with DFL
