#!/bin/bash
# deploy.sh - Deploy face-analysis to reCamera device
...
run_sudo 'killall -q face-analysis detection-blur ppocr-reader yolo8-detector yolo11-detector yolo26-detector yolo11s-detector sscma-node 2>/dev/null || true'
sleep 2
ok "Services stopped"
...
run_sudo "/etc/init.d/S92face-analysis restart" || err "Service start failed"
ok "Service started"
